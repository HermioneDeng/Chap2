    ...
    if (Do_GatherResults_Spatial){
      ...
      # ======================================================================= 
        if (identical(GatherType, "ClimWin")){
          ...
          InputPathMain = file.path("./results/8_Cross_Validation/FinalVariable_allvariables/shum.2m/shum.2m_yday_50/")
          GatherClimWin_Settings = list(Do_MakePlots      = 1,
                                        ...
                                        ClimWinInputPath  = c(file.path(InputPathMain, 
                                                              ...
                                                              file.path(InputPathMain, 
                                                                      "RandomModels")),
                                        ClimwinOutputPath = file.path("./results/8_Cross_Validation/FinalVariable_allvariables/shum.2m/"),
                                        pValueThreshold   = 0.3,
